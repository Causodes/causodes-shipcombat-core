...
Handlebars.registerHelper("shipcombatAllocationUnit", (count, options) =>
  SystemAdapter.current.formatAllocationUnit(count, { capitalize: options?.hash?.capitalize === true })
);
