...
export const DEFAULT_COMBAT_STATE = {
  ...
  roles: {},
  resources: {
    engineer: { heat: 0, powerCores: 0, auxiliaryPower: 0, coreCount: 0, actionChoices: [], extraActions: 0, stagedCores: {}, stagedShieldCores: 0, stagedAuxCores: 0, committedAuxCores: 0, heatCoresStaged: 1, fireCoresStaged: 1, repairAuxPowerStaged: 1, payload: "" },
    ...
    ordnance:  { manpower: 0, manpowerMax: 0, armedTorpedoes: 0, armedCraft: 0, craftDestroyed: 0, craftRecovering: 0, craftPartialRecovery: 0, bosunSL: 0, bosunRolled: false, allocEfficiency: 0, allocExpedience: 0, coreActionUsed: false, commitments: [], stagedPayloads: {}, availablePayloads: 0, coreCount: 0, coreActionsPlayed: [] },
